...
export function Dashboard(){
  ...
  return <div className="shell">
    ...
    <main className="main">
      ...
      {tab==="Event" && <Panel title="Detail Event"><div className="detail"><b>Nama Event</b><span>Beauty Palu 2026</span><b>Tanggal</b><span>26 November 2026</span><b>Venue</b><span>Atrium Palu Grand Mall</span><b>Konsep</b><span>Luxury Beauty Event / High-End Brand Partnership</span><b>Target Audience</b><span>Perempuan 17–40, beauty & fashion enthusiast, masyarakat umum.</span><b>Target Area</b><span>Palu, Sulawesi Tengah + audience luar Palu / Sulawesi Tengah</span></div><div className="toolbar"><button className="primary" onClick={()=>alert("Detail Event dapat diedit melalui konfigurasi event pada versi database production.")}><Pencil size={16}/> Edit Event</button></div></Panel>}
